...
function updateGhostNode(event) {
    ...
    // LAB: mirror into bottom-right status-bar coordinates
    var sbCoordsA = document.getElementById('sb-coords');
    if (sbCoordsA) sbCoordsA.textContent = 'X ' + sx.toFixed(1) + '  Y ' + sy.toFixed(1) + '  Z ' + targetZ.toFixed(1);
...
function duringDrag(event) {
    ...
    // LAB: mirror into bottom-right status-bar coordinates
    var sbCoordsB = document.getElementById('sb-coords');
    if (sbCoordsB) sbCoordsB.textContent = 'X ' + sx.toFixed(1) + '  Y ' + sy.toFixed(1) + '  Z ' + dragNode.z.toFixed(1);
